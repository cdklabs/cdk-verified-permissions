...
made in the Amazon Verified Permissions console. This feature is built for swagger files generated from an ApiGateway
...
##### `mode`<sup>Required</sup> <a name="mode" id="@cdklabs/cdk-verified-permissions.IValidationSettings.property.mode"></a>
